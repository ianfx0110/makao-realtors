...
interface RenterSupportPageProps {
  currentUser: User;
  ...
  return (
    <div className="bg-white rounded-2xl border p-6 space-y-6 max-w-2xl font-sans text-xs text-slate-800">
      <div className="bg-[#F7F9F7] p-4 rounded-xl border flex gap-3 text-[#1B6B3A] text-xs leading-relaxed font-sans">
        ...
        <div>
          <span className="font-extrabold uppercase font-mono text-[10px] tracking-wide block mb-1">Seeker Helpdesk helpline</span>
          Receive technical assistance below if you have questions regarding M-PESA connections, refunds, or landlord details.
        </div>
      </div>
