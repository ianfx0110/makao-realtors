    ...
    <div className="space-y-6 max-w-2xl font-sans text-xs">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <h3 className="font-serif font-bold text-gray-850 text-sm mb-4 uppercase tracking-wide text-[#1B6B3A]">Admin Profile Details</h3>
          <form onSubmit={onUpdateProfile} className="space-y-4 text-xs font-sans">
            <div>
              <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1 font-mono">Admin Name</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1 font-mono">Admin Email Address</label>
              <input
                type="email"
                required
                className="w-full text-xs border p-2.5 bg-white rounded-sm"
            ...
            >
              {updatingProfile ? "Updating..." : "Save Admin Details"}
            </button>
          </form>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <h3 className="font-serif font-bold text-gray-850 text-sm mb-4 uppercase tracking-wide text-amber-700">Change Admin PIN</h3>
          <form onSubmit={onUpdatePassword} className="space-y-4 text-xs">
            <div>
              <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1 font-mono">Current Password PIN</label>
              <input
                type="password"
                required
            ...
            <div>
              <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1 font-mono">New Access PIN</label>
              <input
                type="password"
                required
            ...
            >
              {updatingPassword ? "Changing..." : "Revise PIN Password"}
            </button>
          </form>
        </div>
      </div>
